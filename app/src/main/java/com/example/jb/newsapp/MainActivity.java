...
public class MainActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<List<News>> {
    ...
    private String updateQueryUrl(String searchValue) {
        ...
        sb.append("https://content.guardianapis.com/search?q=").append(searchValue).append("&order-date=published&show-section=true&section=football&show-fields=headline,thumbnail&show-references=author&show-tags=contributor&page=10&page-size=20&api-key=9bd15abc-183d-481d-a3f9-fc383fa6e153");
    ...
    public Loader<List<News>> onCreateLoader(int i, Bundle bundle) {
        ...
        if (mSearchViewField.getQuery().length() > 0) {
            ...
            mUrlRequestGuardianApi = "http://content.guardianapis.com/search?q=&order-by=newest&order-date=published&show-section=true&section=football&show-fields=headline,thumbnail&show-references=author&show-tags=contributor&page=1&page-size=20&api-key=9bd15abc-183d-481d-a3f9-fc383fa6e153";
        }
        return new NewsLoader(this, mUrlRequestGuardianApi);
    }

    @Override
    public void onLoadFinished(Loader<List<News>> loader, List<News> sportsNews) {
        ...
        if (sportsNews != null && !sportsNews.isEmpty()) {
            mAdapter.addAll(sportsNews);
        }
